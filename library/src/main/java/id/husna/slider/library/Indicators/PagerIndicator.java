package id.husna.slider.library.Indicators;
...
import id.husna.slider.library.R;

import id.husna.slider.library.SliderAdapter;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    /**
     * bind this Indicator with {@link id.husna.slider.library.Tricks.ViewPagerEx}
     */
