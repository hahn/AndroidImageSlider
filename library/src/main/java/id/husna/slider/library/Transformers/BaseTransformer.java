package id.husna.slider.library.Transformers;
 ...
 *
 * BaseTransformer implement {@link id.husna.slider.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link id.husna.slider.library.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link id.husna.slider.library.Animations.BaseAnimationInterface}
 * work.
 *
