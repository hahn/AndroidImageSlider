package id.husna.slider.library;
...
import id.husna.slider.library.Animations.BaseAnimationInterface;
import id.husna.slider.library.Indicators.PagerIndicator;
import id.husna.slider.library.SliderTypes.BaseSliderView;
import id.husna.slider.library.Transformers.AccordionTransformer;
import id.husna.slider.library.Transformers.BackgroundToForegroundTransformer;
import id.husna.slider.library.Transformers.BaseTransformer;
import id.husna.slider.library.Transformers.CubeInTransformer;
import id.husna.slider.library.Transformers.DefaultTransformer;
import id.husna.slider.library.Transformers.DepthPageTransformer;
import id.husna.slider.library.Transformers.FadeTransformer;
import id.husna.slider.library.Transformers.FlipHorizontalTransformer;
import id.husna.slider.library.Transformers.FlipPageViewTransformer;
import id.husna.slider.library.Transformers.ForegroundToBackgroundTransformer;
import id.husna.slider.library.Transformers.RotateDownTransformer;
import id.husna.slider.library.Transformers.RotateUpTransformer;
import id.husna.slider.library.Transformers.StackTransformer;
import id.husna.slider.library.Transformers.TabletTransformer;
import id.husna.slider.library.Transformers.ZoomInTransformer;
import id.husna.slider.library.Transformers.ZoomOutSlideTransformer;
import id.husna.slider.library.Transformers.ZoomOutTransformer;
import id.husna.slider.library.Tricks.FixedSpeedScroller;
import id.husna.slider.library.Tricks.InfinitePagerAdapter;
import id.husna.slider.library.Tricks.InfiniteViewPager;
import id.husna.slider.library.Tricks.ViewPagerEx;
...
/**
 * SliderLayout is compound layout. This is combined with {@link id.husna.slider.library.Indicators.PagerIndicator}
 * and {@link id.husna.slider.library.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout{
    ...
    /**
     * {@link id.husna.slider.library.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link id.husna.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link id.husna.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link id.husna.slider.library.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link id.husna.slider.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link id.husna.slider.library.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link id.husna.slider.library.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link id.husna.slider.library.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see id.husna.slider.library.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link id.husna.slider.library.Indicators.PagerIndicator} shape, rect or oval.
     */
     ...
     * {@link id.husna.slider.library.Animations.BaseAnimationInterface},
     * and you can see a example in {@link id.husna.slider.library.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link id.husna.slider.library.Indicators.PagerIndicator} instance.
